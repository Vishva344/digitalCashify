        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse text-center" id="mynavbar">
                <ul class="navbar-nav ml-auto">
                    ...
                    <!-- <li class="nav-item">
                        <a href="" class="nav-link text-white">About Us<
                    </li> -->
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="text-container">
                    ...
                    <h4>Secure and Fastest way to transfer money</h4>
                    <br>
                    <button class="btn btn-primary btn-lg ml-auto"><a href="transaction.php" style="text-decoration: none;" class="deco">Transact Now</a></button>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="image-container " style="margin-top: 50px;">
                    <img src="images/bank2.png" alt="alternative" class="img-fluid" height="600px" width="600px">
                </div>
            </div>
        </div>
    </div>
